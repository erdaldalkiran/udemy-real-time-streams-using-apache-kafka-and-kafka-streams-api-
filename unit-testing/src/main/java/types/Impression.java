...
public class Impression extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5922096949608289338L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Impression\",\"namespace\":\"types\",\"fields\":[{\"name\":\"ImpressionID\",\"type\":\"string\"},{\"name\":\"Campaigner\",\"type\":\"string\"}]}");
  ...
  private java.lang.CharSequence ImpressionID;
   ...
   * @param ImpressionID The new value for ImpressionID
   * @param Campaigner The new value for Campaigner
   */
  public Impression(java.lang.CharSequence ImpressionID, java.lang.CharSequence Campaigner) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
      case 0:
        ImpressionID = (java.lang.CharSequence) value$;
        break;
      case 1:
  ...
  /**
   * Gets the value of the 'ImpressionID' field.
   * @return The value of the 'ImpressionID' field.
   */
  public java.lang.CharSequence getImpressionID() {
    return ImpressionID;
  }


  /**
   * Sets the value of the 'ImpressionID' field.
   * @param value the value to set.
   */
  public void setImpressionID(java.lang.CharSequence value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Impression>
    ...
    private Builder(types.Impression.Builder other) {
      super(other);
      if (isValidValue(fields()[0], other.ImpressionID)) {
        this.ImpressionID = data().deepCopy(fields()[0].schema(), other.ImpressionID);
        fieldSetFlags()[0] = other.fieldSetFlags()[0];
      }
      if (isValidValue(fields()[1], other.Campaigner)) {
        this.Campaigner = data().deepCopy(fields()[1].schema(), other.Campaigner);
    ...
    /**
     * Sets the value of the 'ImpressionID' field.
     * @param value The value of 'ImpressionID'.
     * @return This builder.
     */
    public types.Impression.Builder setImpressionID(java.lang.CharSequence value) {
    ...
    /**
     * Checks whether the 'ImpressionID' field has been set.
     * @return True if the 'ImpressionID' field has been set, false otherwise.
     */
    ...
    /**
     * Clears the value of the 'ImpressionID' field.
     * @return This builder.
     */
    public types.Impression.Builder clearImpressionID() {
      ImpressionID = null;
     ...
     * @return This builder.
     */
    public types.Impression.Builder setCampaigner(java.lang.CharSequence value) {
     ...
     * @return This builder.
     */
    public types.Impression.Builder clearCampaigner() {
      Campaigner = null;
    ...
    public Impression build() {
      try {
        ...
        record.ImpressionID = fieldSetFlags()[0] ? this.ImpressionID : (java.lang.CharSequence) defaultValue(fields()[0]);
        record.Campaigner = fieldSetFlags()[1] ? this.Campaigner : (java.lang.CharSequence) defaultValue(fields()[1]);
        return record;
  ...
  public void customDecode(org.apache.avro.io.ResolvingDecoder in)
    ...
    if (fieldOrder == null) {
      this.ImpressionID = in.readString(this.ImpressionID instanceof Utf8 ? (Utf8) this.ImpressionID : null);

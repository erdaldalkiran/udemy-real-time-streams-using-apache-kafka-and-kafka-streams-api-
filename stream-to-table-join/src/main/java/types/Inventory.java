...
public class Inventory extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private java.lang.CharSequence NewsType;
   ...
   */
  public Inventory(java.lang.CharSequence InventoryID, java.lang.CharSequence NewsType) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
      case 0:
        ...
        break;
      case 1:
        NewsType = (java.lang.CharSequence) value$;
        break;
      default:
        throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
   ...
   */
  public java.lang.CharSequence getNewsType() {
    return NewsType;
  }
   ...
   * @param value the value to set.
   */
  public void setNewsType(java.lang.CharSequence value) {
    this.NewsType = value;
  }
   ...
   */
  public static types.Inventory.Builder newBuilder() {
    return new types.Inventory.Builder();
  }
   ...
   * @return A new Inventory RecordBuilder
   */
  public static types.Inventory.Builder newBuilder(types.Inventory.Builder other) {
    if (other == null) {
      return new types.Inventory.Builder();
    } else {
      return new types.Inventory.Builder(other);
    }
  }
   ...
   * @return A new Inventory RecordBuilder
   */
  public static types.Inventory.Builder newBuilder(types.Inventory other) {
    if (other == null) {
      return new types.Inventory.Builder();
    } else {
      return new types.Inventory.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Inventory>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(types.Inventory.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(types.Inventory other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.InventoryID)) {
        this.InventoryID = data().deepCopy(fields()[0].schema(), other.InventoryID);
     ...
     * @return This builder.
     */
    public types.Inventory.Builder setInventoryID(java.lang.CharSequence value) {
     ...
     * @return This builder.
     */
    public types.Inventory.Builder clearInventoryID() {
      InventoryID = null;
     ...
     * @return This builder.
     */
    public types.Inventory.Builder setNewsType(java.lang.CharSequence value) {
     ...
     * @return This builder.
     */
    public types.Inventory.Builder clearNewsType() {
      NewsType = null;
    ...
    public Inventory build() {
      try {
        ...
        record.NewsType = fieldSetFlags()[1] ? this.NewsType : (java.lang.CharSequence) defaultValue(fields()[1]);
        return record;
